...
{      
       ...
       {
            //
            var C = getCSubM(m, angularFrequency, waterWaveVelocity, sphereWaveVelocity); 
            //
 ...
 * Function is not stable.
 */
function getFluidSphereSolution(lowerBound, upperBound, increment, waterWaveVelocity, sphereWaveVelocity)
{
    //
    acousticScatteringForAFluidSphereData=[];
    //
    acousticScatteringForAFluidSphereData.push(["Frequency(kHz)","Target Strength (dB)"]);
    //
    for (var angularFrequency=lowerBound; angularFrequency<upperBound; angularFrequency+=increment)
    {
        //
        acousticScatteringForAFluidSphereData.push([parseFloat(angularFrequency),parseFloat(getFarFieldWaveEquationSolution(angularFrequency, waterWaveVelocity, sphereWaveVelocity))]);
    }
    //
...
function plotSolutionOnClick()
{
    ...
    //
    acousticScatteringForAFluidSphereGraph.draw(google.visualization.arrayToDataTable(getFluidSphereSolution(lowerBound, upperBound, increment, waterWaveVelocity, sphereWaveVelocity)), acousticScatteringForAFluidSphereOptions);
}
...
{
    //
    if(document.getElementById('toolSelector').value==="sphereScattering")
    {
        //
